...
export default function Footer() {
  ...
  return (
    <footer className="bg-gr-purple w-full bg-opacity-0 p-8 text-white transition-all duration-200 lg:pl-32 lg:pr-32">
      ...
      <div className="from-gr-pink to-gr-purple my-4 h-0.5 w-full bg-gradient-to-r"></div>
